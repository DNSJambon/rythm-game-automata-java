...
private int jjMoveStringLiteralDfa2_0(long old0, long active0){
   ...
   switch(curChar)
   {
      case 121:
         if ((active0 & 0x20L) != 0L)
            return jjStartNfaWithStates_0(2, 5, 59);
         break;
      default :
         break;
   }
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 348 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   320, 325, 326, 332, 338, 344, 347, 309, 314, 316, 272, 287, 288, 304, 305, 262, 
   263, 264, 229, 269, 237, 240, 242, 248, 250, 258, 260, 223, 228, 232, 234, 209, 
   213, 216, 67, 68, 220, 166, 170, 186, 187, 204, 205, 157, 163, 150, 153, 140, 
   148, 133, 135, 137, 87, 90, 96, 111, 113, 128, 130, 72, 76, 79, 82, 66, 
   67, 68, 
};
...
static final long[] jjtoMore = {
   0x0L, 
    ...
    private final int[] jjrounds = new int[348];
    private final int[] jjstateSet = new int[2 * 348];
